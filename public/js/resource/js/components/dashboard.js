            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios.patch("api/user/".concat(_this.user.id), _this.user).then(function (response) {
                  ...
                  _this.profile.picture = response.data.user.person.picture;
                  _this.profile.name = response.data.user.person.name;
                  _this.profile.bio = response.data.user.person.summaryOfBio;
                  _this.profile.professionalHeadline = response.data.user.person.professionalHeadline;
                  _this.user_account = true;
