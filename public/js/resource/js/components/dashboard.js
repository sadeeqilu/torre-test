...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    if (this.user.username !== '') this.user_account = true;
    this.getUser();
  },
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return axios.patch("api/user/".concat(_this.user.id), _this.user).then(function (response) {
                  console.log(response);
                  _this.profile.picture = response.user.person.picture;
                  _this.profile.name = response.user.person.name;
                  _this.profile.bio = response.user.person.summaryOfBio;
                  _this.profile.professionalHeadline = response.user.person.professionalHeadline;
                  _this.user_account = true; // this.signIn()
                })["catch"](function (_ref) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios.get("api/user/".concat(_this2.user.id)).then(function (response) {
                  console.log(response);
                  _this2.profile.picture = response.data.user.person.picture;
                  _this2.profile.name = response.data.user.person.name;
                  _this2.profile.bio = response.data.user.person.summaryOfBio;
                  _this2.profile.professionalHeadline = response.data.user.person.professionalHeadline; // this.signIn()
          ...
          _vm.user_account
            ? _c("div", { staticClass: "card-body" }, [
                _c("div", { staticClass: "mt-5" }, [
                  _c("div", { staticClass: "image-container text-center" }, [
                    _c("img", {
                      staticClass: "border border-1 rounded-circle",
                      attrs: { src: _vm.profile.picture, alt: "profile name" }
                    })
                  ]),
                  _vm._v(" "),
                  _c("dl", { staticClass: "row" }, [
                    ...
                    _vm._v(" "),
                    _c("dd", { staticClass: "col-sm-9" }, [
                      _vm._v(_vm._s(_vm.profile.professionalHeadline))
                    ]),
                    _vm._v(" "),
                  ...
                  [
                    _c("div", { staticClass: "form-group col-12" }, [
                      _c(
                        ...
                        [_vm._v("Please Enter Your Torre Account Username")]
                      ),
                      _vm._v(" "),
                      _c("input", {
                        directives: [
                        ...
                        attrs: {
                          ...
                          name: "email",
                          id: "username",
                          placeholder: "Enter Your Torre Account username",
                          required: ""
                        },
  ...
  function() {
    ...
    return _c("p", [
      _c(
        "a",
        {
          attrs: { href: "https://accounts.torre.co/user/", target: "_blank" }
        },
        [_vm._v("click here to see more.")]
      )
    ])
  }
]
